...
<html>
	<head>
		...
		<style type="text/css">
			...
			.headerultools:hover .headerlitools_ulinfo{
				display: block;
			}
		</style>
	...
	<body>
		<div class="dvheader">
			<div class="dvheadertools">
				<span class="headerspantitle">旅游管理系统</span>
				<ul class="headerultools">
					...
					<li class="headerlitools_info headerlitools" style="background-color: #075597">
						...
						<%=((admin)session.getAttribute("ad")).getAdname()%>
						...
						<ul class="headerlitools_ulinfo">
							...
							<li style="border-top: 1px solid #E4ECF3;">
								...
								<a href="/travel/adminServlet" style="color: black; text-decoration: none;">注销</a>
							</li>
						</ul>
					</li>
				</ul>
		...
		<div class="dvcontent">
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<a href="Mscenic.jsp" target="right">
							<li>景点信息</li>
						</a>
						<a href="/travel/userPageServlet" target="right">
							<li>用户管理</li>
						</a>
			...
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe src="Mscenic.jsp" scrolling="no" width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
